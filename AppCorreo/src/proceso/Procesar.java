...
public class Procesar {
    ...
    private String ayuda() {
        return "Este es el formato de los comandos"
                + "Las Consultas de las tablas deben estar en medio de los comandos"
                + "<comando>"
                + "</comando>"
                + "G Accion Tabla Datos"
                + "Donde Accion debe tener uno de estos valores"
                + "L	listar los registros"
                + "A	Agregar nuevos registros"
                + "B	Eliminar Registros"
                + "M	Modificar Registros"
                +"Tabla debe tener uno de estos valores"
                 +"Persona"
                 +"Docente"
                 +"Carrera"
                 +"MateriaCarrera"
                 ...
                 +"Materia"
                 +"PreRequisito"
                 +"Datos deben ser los Atributos de cada tabla separadas por coma"
                 +"Ejemplo:Para la Tabla Persona"
                 +"per_ci,per_nombre,per_apellidos,per_genero,per_fecha_nac,per_telefono,per_telefonomovil,per_email"
                 +"Entonces el Comando Final se haria de la siguiente manera dentro del cuerpo del correo:"
                +"Para Listar:"
                +"<comando>"
                +"G L Persona"
                +"</comando>"
                +"Agregar:"
                +"<comando>"
                +"G A Personaper_ci,per_nombre,per_apellidos,per_genero,per_fecha_nac,per_telefono"
                +"</comando>"
                +"Eliminar:"
                +"<comando>"
                +"G B Persona per_id,per_ci,per_nombre,per_apellidos,per_genero,per_fecha_nac,per_telefono"
                +"</comando>"
                +"Modificar:"
                +"G M Persona per_id,per_ci,per_nombre,per_apellidos,per_genero,per_fecha_nac,per_telefono"
                +"</comando>"
    ...
    private String insertar(String tabla, String[] campos) {
        ...
        if (tabla.equals("PERSONA")) {
            ...
            try {
                id = gc.insertar(campos[0].trim(),campos[1].trim(), Integer.parseInt(campos[2].trim()));
